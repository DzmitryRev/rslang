...
/**
 * TODO:
 * Верстка, то что тут имеется можно перемещать внутри тегов как угодно. главное не изменять их самих. В общем оробачивать можно во что угодно и стилизовать таким образом.
 * Если надо зайти глубже то WordList компонент - компонент, содержащий карточки, а WordCard - сама карточка. Файлы * стилей находятся в соответсвующих папках
 * Стили для этой страницы пишем в Textbook.module.css
 * По пагинации все просто: в компонент Pagination можно не заходить, я выписал нужные стили с пометками что для чего в файл Pagination.module.css
 * Так же нужно добавить иконки для футера и хеадера. Катя походу забыла их закинуть. Я теги имг с этими картинками закоментил, когда имги появятся - можно раскоментить
 *
