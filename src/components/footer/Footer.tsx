...
export default function Footer() {
  return (
    <footer className={`${styles.footer} ${styles.footerContainer}]} ${styles.container}`}>
      ...
      <nav className={styles.footer__menu}>
        ...
        <ul className={styles.footer__menuList}>
          ...
          <li className={styles.footer__menuItem}>
            <Link className={styles.footer__link} to={'/game'} state={{ game: 'sprint' }}>
              Спринт
            </Link>
          </li>
          <li className={styles.footer__menuItem}>
            <Link className={styles.footer__link} to={'/game'} state={{ game: 'audiocall' }}>
              Аудиовызов
            </Link>
          </li>
          <li className={styles.footer__menuItem}>
